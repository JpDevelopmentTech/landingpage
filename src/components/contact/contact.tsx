...
export default function Contact() {
  ...
  const sendForm = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    emailjs.sendForm('service_pv3ijj7', 'template_46y7uqi', e.currentTarget, '7tCFlg7bszyEfla2D').then((result) => {
  ...
  return (
    <div className="h-screen w-full bg-black " id="contact">
      {message && (
        <div>
      ...
      <div className="2xl:mx-auto 2xl:container lg:px-20 lg:py-16 md:py-12 md:px-6 py-12 px-4 w-96 sm:w-auto">
        ...
        <div className="w-full flex justify-center items-center">
          <form className="w-2/3 py-12 flex flex-col gap-6" onSubmit={sendForm}>
            ...
            ></textarea>
            <button type="submit" className="bg-primary p-3 rounded-md hover:transition-colors hover:bg-primary-200">Enviar mensaje</button>
          </form>
        </div>
      </div>
    </div>
